...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::activity::list_activity_types_with_usage,
            commands::activity::create_activity_category,
            commands::activity::update_activity_category,
            commands::activity::delete_activity_category,
            commands::activity::create_activity_type,
            commands::activity::update_activity_type,
            commands::activity::delete_activity_type,
            commands::pacing::get_daily_loads,
            commands::pacing::get_activity_history,
            commands::dashboard::get_dashboard_summary,
            commands::dashboard::get_rolling_averages,
            commands::monthly_activity::get_monthly_activity,
            commands::monthly_activity::upsert_monthly_activity,
